...
func SendRequest(req *pbv1.ChatRequest, opts SendRequestOptions) (EgressResult, error) {
	if req == nil {
...
func EncodeRequest(req *pbv1.ChatRequest) (string, error) {
	if req == nil {
...
func DecodeRequest(encoded string) (*pbv1.ChatRequest, error) {
